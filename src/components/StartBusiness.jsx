...
const StartBusiness = () => {
  const [show, startBusinessRef] = useObserver();
  ...
  return (
    <section className="startBusiness_section" style={BG_IMG_STYLE}>
      <div className="startBusiness_wrapper" ref={startBusinessRef}>
        ...
        <h1 className="startBusiness_heading">
          THE PERFECT PLACE TO START YOUR BUSINESS
        </h1>
        <p className="startBusiness_para">
          A team of highly driven professionals with years of in-depth
          experience in the IT and business space. Our mission is to help
          oranizations leverage digital potential to its maximum efficiency.
        </p>
